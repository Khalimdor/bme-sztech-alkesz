...
/**
 * Represents the usage of the network layer. The main function takes one
 * parameter, a node id that is logged to the console.
 */
public class ClusterTest {
	...
	public static void main(final String[] args) {
		...
		try (ConnectedNode connectedNode = cluster.connect(new TestObjectReceiver(nodeId), new TestFailureListener())) {
